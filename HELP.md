...
* The following dependencies are not known to work with Spring Native: 'Flyway Migration, Spring Boot DevTools'. As a result, your application may not work as expected.
...
```
$ docker run --rm pub:0.0.1-SNAPSHOT
```
